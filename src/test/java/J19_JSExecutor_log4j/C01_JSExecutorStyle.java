...
public class C01_JSExecutorStyle extends TestBase {
    ...
    public void test01() {
        ...
        jse.executeScript("arguments[0].style.backgroundColor='black'", seacrhBox); //searchBox webelemneti içini yeşil yaptık
        jse.executeScript("arguments[0].style.color='white'", seacrhBox); //searchBox webelemneti içindeki yazıyı sari yaptık
